...
namespace UnityChan
{
	public class AutoBlink : MonoBehaviour
	{
		...
		void SetCloseEyes ()
		{
			ref_SMR_EYE_DEF.SetBlendShapeWeight (1, ratio_Close);
			ref_SMR_EL_DEF.SetBlendShapeWeight (16, ratio_Close);
		}

		void SetHalfCloseEyes ()
		{
			ref_SMR_EYE_DEF.SetBlendShapeWeight (1, ratio_HalfClose);
			ref_SMR_EL_DEF.SetBlendShapeWeight (16, ratio_HalfClose);
		}

		void SetOpenEyes ()
		{
			ref_SMR_EYE_DEF.SetBlendShapeWeight (1, ratio_Open);
			ref_SMR_EL_DEF.SetBlendShapeWeight (16, ratio_Open);
		}
