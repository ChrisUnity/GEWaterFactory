...
#pragma warning restore 0414
        ...
        {
#if UNITY_IOS
			Debug.Log("ReplayKitRecorder#Countdown:" + countDownNumber);
        ...
        {
#if UNITY_IOS
			Debug.Log("ReplayKitRecorder#StartRecording recording:" + recording);
            if (!ReplayKit.APIAvailable)
            {
                return;
            }
            ...
            if (!recording)
			{			
				//Debug.Log("ReplayKitRecorder#StartRecording really run");
